...
export function getSearchProducts(search) {
  return function (dispatch) {
    return axios
      .get("http://localhost:3001/products/searches/" + search, {
...
export function addCategory(category) {
  return function (dispatch) {
    return axios
      .post("http://localhost:3001/categories/add/", category, {
        withCredentials: true,
      })
      .then((result) => {
        dispatch({
...
export function modifyCategory(body, name) {
  return function (dispatch) {
    return axios
      .put(`http://localhost:3001/categories/modify/${name}`, body, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((data) => {
...
export function deleteCategory(category) {
  return function (dispatch) {
    return axios
      .delete(`http://localhost:3001/categories/${category}`)
      .then(() => {
        dispatch({
...
export function updateProduct(body) {
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/products/update/`, body)
      .then(() => {
        dispatch({
          type: UPDATE_PRODUCT,
          payload: body,
...
export function deleteProduct(id) {
  return function (dispatch) {
    return axios.delete(`http://localhost:3001/products/${id}`).then(() => {
      dispatch({
        type: DELETE_PRODUCT,
        payload: id,
      });
...
export function deleteCatxProd(name, id) {
  return function (dispatch) {
    return axios
      .delete(`http://localhost:3001/products/cxp/${id}/${name}`)
      .then(() => {
        dispatch({
          type: DELETECATXPROD,
          payload: { name, id },
...
export function getCategoriesxProducts() {
  return function (dispatch) {
    return axios
      .get("http://localhost:3001/products/cxp", { withCredentials: true })
      .then((result) => result.data)
      .then((data) => {
        dispatch({
...
export function addUser(body) {
  return function (dispatch) {
    return axios
      .post("http://localhost:3001/users/adduser", body, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((data) => {
...
export function addCart(idProduct, idUser) {
  ...
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/${idUser}/cart/`, body, {
        withCredentials: true,
      })
      .then(() => {
        dispatch({
...
export function addCartInvited(ids, idUser) {
  ...
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/${idUser}/invited/cart/`, body, {
        withCredentials: true,
      })
      .then(() => {
        dispatch({
...
export function getAllCart(idUser) {
  return function (dispatch) {
    return axios
      .get(`http://localhost:3001/users/${idUser}/cart/`, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((productsCart) => {
...
export function updateCart(idUser, body) {
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/${idUser}/c/cart`, body, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((result) => {
...
export function priceOrder(idUser, total) {
  ...
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/${idUser}/c/order`, body)
      .then((result) => result.data)
      .then((result) => {
        dispatch({
...
export function completeCart(idUser, addres) {
  ...
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/${idUser}/update/cart`, body, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((result) => {
...
export function finishorder(idUser, idOrder) {
  ...
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/${idUser}/aceptar/${idOrder}`, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((result) => {
...
export function celarordenPanel(idUser, idOrder) {
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/${idUser}/canc/${idOrder}`, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((result) => {
...
export function getOrders(status) {
  return function (dispatch) {
    return axios
      .get(`http://localhost:3001/orders/status/${status}`, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((result) => {
...
export function addReview(aux, idProduct) {
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/products/${idProduct}/review`, aux)
      .then((result) => result.data)
      .then((data) => {
        dispatch({
          type: ADD_REVIEW,
...
export function loginUser(body) {
  ...
  return function (dispatch) {
    return axios
      .post("http://localhost:3001/login", body, { withCredentials: true })
      .then((result) => result.data)
      .then((data) => {
        dispatch({
          type: LOGIN_USER,
...
export function getReviews(id) {
  return function (dispatch) {
    return axios
      .get(`http://localhost:3001/products/${id}/review`)
      .then((result) => result.data)
      .then((result) => {
        dispatch({
          type: GET_REVIEWS,
...
export function getOrdersxproduct(idProd) {
  return function (dispatch) {
    return axios
      .get(`http://localhost:3001/orders/ORDD/${idProd}`)
      .then((result) => result.data)
      .then((result) => {
        dispatch({
...
export function getproductsxorders(idOrder) {
  ...
  return function (dispatch) {
    return axios
      .get(`http://localhost:3001/orders/products/${idOrder}`)
      .then((result) => result.data)
      .then((result) => {
        dispatch({
...
export function getAllReviews() {
  return function (dispatch) {
    return axios
      .get("http://localhost:3001/products/reviews/allReviews")
      .then((result) => result.data)
      .then((result) => {
        dispatch({
...
export function activeaccount(idUser) {
  return function (dispatch) {
    return axios
      .get(`http://localhost:3001/users/activeaccount/${idUser}`, {
        withCredentials: true,
      })
      .then((result) => result.data)
      .then((result) => {
...
export function sendemailorder(User, body) {
  ...
  return function (dispatch) {
    return axios
      .post(
        `http://localhost:3001/users/sendorder/${first}/${last}/${email}`,
        body,
        { withCredentials: true }
      )
      .then((result) => result.data)
...
export function deleteProductCart(orderId, productId) {
  return function (dispatch) {
    return axios
      .delete(
        `http://localhost:3001/orders/orderdelete/${orderId}/${productId}`
      )
      .then((result) => result.data)
      .then((data) => {
        dispatch({
...
export function getSumaryCart(idUser) {
  ...
  return function (dispatch) {
    return axios
      .get("http://localhost:3001/users/cart/sumary/" + idUser)
      .then((result) => result.data)
      .then((data) => {
        dispatch({
...
export function sendEmailVisited(body) {
  return function (dispatch) {
    return axios
      .post(`http://localhost:3001/users/send_email/`, body)
      .then((result) => result.data)
      .then((data) => {
        dispatch({
