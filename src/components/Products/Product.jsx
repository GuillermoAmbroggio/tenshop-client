        ...
        <div class="product-details">
            ...
            >
              <div class="carousel-inner">
                <div class="item active">
                  {!!img1 ? (
                    <a onMouseOver={(e) => changeImage(img1, 1)}>
                      <img
                        id={"img1"}
                        src={img1}
                        width="84"
                  ...
                  {!!img2 ? (
                    <a onMouseOver={(e) => changeImage(img2, 2)}>
                      <img
                        id={"img2"}
                        src={img2}
                        width="84"
                  ...
                  {!!img3 ? (
                    <a onMouseOver={(e) => changeImage(img3, 3)}>
                      <img
                        id={"img3"}
                        src={img3}
                        width="84"
                  ...
                  <a onMouseOver={(e) => changeImage(img4, 4)}>
                    <img id={"img4"} src={img4} width="84" height="85" alt="" />
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-7 title text-center">
            <div class="product-information">
              ...
              <p>
                <b>Availability:</b> {resultado && resultado.stock}
              </p>
              <p>
                <b>State:</b> New
              </p>
              ...
              <p>
                ...
                <Rater
                  total={5}
                  rating={promedy(acum, reviews.length)}
                  interactive={false}
                  style={{ fontSize: "30px" }}
              ...
              <a>
                <img
                  style={{ margin: "0 auto" }}
                  src="https://cuidar.org/images/icons/formasdepago/mini_tarjetas.jpg"
                  width="200"
                  height="350"
