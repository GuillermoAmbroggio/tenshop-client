        ...
        <form className={classes.form} noValidate>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              ...
              />
              <FormHelperText id="help" children={errors.firstname} />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                inputProps={{ style: { fontSize: 20 } }}
              />
              <FormHelperText id="help" children={errors.surname} />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                inputProps={{ style: { fontSize: 20 } }}
              />
              <FormHelperText id="help" children={errors.email} />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                inputProps={{ style: { fontSize: 20 } }}
              />
              <FormHelperText id="help" children={errors.username} />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                inputProps={{ style: { fontSize: 20 } }}
              />
              <FormHelperText id="help" children={errors.password} />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                inputProps={{ style: { fontSize: 20 } }}
              />
              <FormHelperText id="help" children={errors.password2} />
            </Grid>
          </Grid>
          <Button
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    addCartInvited: (diProduc, idUser) =>
      dispatch(addCartInvited(diProduc, idUser)),
  };
};
