...
function Cart({
  ...
  const handleCantidadDelProducto = (id, price) => {
    ...
    document.getElementById("total_precio_producto" + id).innerHTML =
      "$" + resultado;
  ...
  function alerttinvited(e) {
    ...
    Swal.fire({
      ...
      title: "Ups...!",
      html:
        '<span class="aaaa">Please <b>login</b> or <b>register</b> to finalize your purchase. Thank you!</span>',
      footer:
        '<a class="btn btn-info" href="http://tenshop.vercel.app/signin">LOG IN</a>' +
        "&nbsp &nbsp" +
        '<a class="btn btn-warning" href="http://tenshop.vercel.app/signup">SIGN UP</a>',
    });
  }
    ...
    if (typeof onlineUser == "object") {
      Swal.fire({
        ...
        if (result.value) {
          ...
          Swal.fire("Deleted!", "Your cart has been clear.", "success");
        }
      });
    } else {
      Swal.fire({
    ...
    if (typeof onlineUser == "object") {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          Swal.fire("Deleted!", "The product has been clear.", "success");
        }
      });
    } else {
      let arry = [];
  ...
  return arr.length !== 0 ? (
                                ...
                                <td class="cart_quantity">
                                  <div class="cart_quantity_button">
                                    ...
                                    <input
                                      ...
                                      id={e.id + "input"}
                                      onClick={() =>
                                        handleCantidadDelProducto(e.id, e.price)
                                      }
              ...
              <div class="total_area" style={{ width: "100%" }}>
                <ul style={{ paddingLeft: "0px" }}>
                  ...
                  <li>
                    ...
                    <span id="taxes">
                      $
                      {sumary_cart.contadorEcoTax
                        ? sumary_cart.contadorEcoTax
                        : "0"}
                    </span>
                  </li>
                  <li>
                    Shipping Cost <span id="shipping">$400</span>
                  </li>
                  <li>
                    Total{" "}
                    <span id="total">
                      ${sumary_cart.total ? sumary_cart.total : "0"}
                    </span>
                  </li>
                </ul>
    ...
    <div className="alertacartguille">
      Your{" "}
      <span style={{ color: "black", margin: "0px 10px 0px 10px" }}>Cart</span>{" "}
      is Empty!
    </div>
  );
}
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    deleteProductCart: (orderId, productId) =>
      dispatch(deleteProductCart(orderId, productId)),
