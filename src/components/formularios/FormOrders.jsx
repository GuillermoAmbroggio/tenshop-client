    ...
    return (
      <div className="container">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div className="alertorderguille3">
                  <span style={{ color: "black", margin: "0px 10px 0px 10px" }}>
                    Orders
                  </span>{" "}
                  Summary
                  <button
          ...
          <span aria-hidden="true">&times;</span>
              ...
              <div class="modal-body">
                <table class="table">
                  ...
                  <tbody>
                    {productsxorder.products &&
                      productsxorder.products.map((p, i) => {
                        return (
                          <tr>
                            <th scope="row">{i}</th>
                            <td>{p.name}</td>
                ...
                <div className="alertorderguille">
                  <span style={{ color: "black", margin: "0px 10px 0px 10px" }}>
                    Orders
                  </span>{" "}
                  Details
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row">{productsxorder.address}</th>
                      <td>Credit Card</td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section class="contact-block jumbotron">
          <div class="container">
            <div
              class="col-md-12 contact-form alert alert-secondary"
              style={{ paddingBottom: "25px" }}
            >
              <div className="alertaguille">
                Management{" "}
            ...
            {orders.length !== 0 && (
              <div class="col-md-12 contact-form alert alert-dark">
                <div className="alertaguille2">
                  Orders{" "}
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <span className="palabras">
                              {" "}
                              {p.user.firstname.toUpperCase()}{" "}
                              {p.user.surname.toUpperCase()}
                            </span>{" "}
                          </td>
                          <td>
                            <span className="palabras">
                          ...
                          <td>
                            {" "}
                            <span className="palabras"> $ {p.total_price}</span>
                          </td>
                        </tr>
                      );
                    })}
